...
task :setup do
  ...
  if File::exist? "out/img/favicons/favicon-16x16.png" and File::exist? "out/img/favicons/favicon-32x32.png"
    cp "out/img/favicons/favicon-16x16.png", "Consul.docset/icon.png"
    cp "out/img/favicons/favicon-32x32.png", "Consul.docset/icon@2x.png"
  else
...
task :copy do
  ...
  file_list.each do |path|
    ...
    when source.match(/\.html$/)
      ...
      doc.title = doc.title.sub(" - Kubernetes", "")
